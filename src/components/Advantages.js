    ...
    <div className="w-full flex content pb-10">
      <div className="w-[100%] lg:w-[90%] md:w-[80%] mx-auto flex flex-col">
        ...
        <div className="w-full flex bg-white xl:flex-row flex-col">
          <div className="xl:w-1/4 w-full border-r-[1px] border-slate-200 flex flex-col px-10 py-5">
            <p className="py-4 text-[#C28563] text-5xl">
              <FaHandHoldingUsd />
            </p>
            ...
            <button className="flex w-fit mt-4 bg-[#C28563] text-white tracking-widest p-3 ease-in duration-500 hover:bg-[#19130B]">
