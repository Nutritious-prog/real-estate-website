  ...
  return (
    <Slide>
      <div className="each-slide-effect xl:h-[100vh] h-[48vh] w-[100vw] flex">
        ...
        <div className="xl:w-[50%] w-[90%] mx-auto flex justify-center text-center flex-col text-white tracking-widest ">
        <span className="xl:text-2xl text-lg p-2">DISCOVER OUR MODERN VILLA</span>
          <h2 className="xl:text-5xl text-2xl p-5">BUILDING EMPIRE STATE SUPREME RESIDENCE</h2>
          <div className="flex w-full justify-evenly xl:p-5 mx-auto">
      ...
      <div className="each-slide-effect xl:h-[100vh] h-[48vh] w-[100vw] flex">
        ...
        <span className="xl:text-2xl text-lg p-2">DISCOVER OUR MODERN VILLA</span>
          ...
          <div className="flex w-full justify-evenly xl:p-5 mx-auto">
            ...
            <button className="flex bg-[#C28563] text-white tracking-widest xl:p-3 p-1 ease-in duration-500 hover:bg-[#19130B] ml-1">
              <p className="p-2">MORE INFO</p>
              <p className="p-3 font-thin">
                <FaGreaterThan />
              </p>
